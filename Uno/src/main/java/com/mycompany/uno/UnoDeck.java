...
public class UnoDeck {
	...
	public UnoCard drawCard() throws IllegalArgumentException{
		if(isEmpty()) {
			throw new IllegalArgumentException("Tidak bisa mengambil kartu ketika tidak ada kartu di deck");
		}
	...
	public ImageIcon drawCardImage() throws IllegalArgumentException {
		if(isEmpty()) {
			throw new IllegalArgumentException("Tidak bisa mengambil kartu ketika deck kosong");
			}
